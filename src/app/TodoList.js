		...
		return (
			<div>
				<Row gutter={{xs: 8, sm: 16, md: 24, lg: 32}}>
					<Col span={18}>
						<Input placeholder="请输入待办事项" value={this.state.inputValue} onPressEnter={this.onPressEnter}
									 onChange={this.updateInputValue}
									 className={'todo'}/>
					</Col>
					<Col span={6}>
						<Button htmlType={'button'} onClick={this.addItem} type={'primary'} icon={'add'}>添加</Button>
						<Button onClick={success}>打印完成</Button>
						<Button type={'info'} onClick={printing}>打印</Button>
					</Col>
				</Row>
				<Row>
